...
class ShortTermMemory:
    ...
    def __init__(self, message_repo: MessageRepository, config: Union[Dict[str, Any], PersonaConfig]):
        """初始化短期记忆管理器
