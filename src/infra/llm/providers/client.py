...
class LLMClient:
    ...
    async def chat(
        ...
        *,
        ...
        return self._message_content_to_text(response_message)
    ...
    async def chat_with_tools(
        ...
        *,
        ...
        return LLMToolCallResponse(message=message, tool_calls=tool_calls)
    ...
    async def structured_output(
        ...
        *,
        ...
        try:
            ...
            return LLMStructuredOutput(data=None, raw_text=content)

        return LLMStructuredOutput(data=data, raw_text=content)
