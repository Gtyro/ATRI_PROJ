                ...
                <el-descriptions border>
                  ...
                  >
                    ...
                    <el-button
                      type="primary"
                      size="small"
                      @click="runPresetQuery(preset.query)"
                    >
                      执行
                    </el-button>
                    <el-button
                      type="info"
                      size="small"
                      @click="showPresetSQL(preset.query)"
                    >
                      查看SQL
                    </el-button>
                  </el-descriptions-item>
                ...
                <el-descriptions border>
                  ...
                  >
                    ...
                    <el-button
                      type="primary"
                      size="small"
                      @click="runPresetCypher(preset.query)"
                    >
                      执行
                    </el-button>
                    <el-button
                      type="info"
                      size="small"
                      @click="showPresetCypher(preset.query)"
                    >
                      查看Cypher
                    </el-button>
                  </el-descriptions-item>
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="copyToClipboard"
            >复制到剪贴板</el-button
          >
          <el-button type="success" @click="executePreviewQuery"
            >执行查询</el-button
          >
        </span>
      </template>
